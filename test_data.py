class TestData:
    test_data_1 = ['Никита','Ермаков', 'Московский проспект, 1', 'Преображенская площадь', '+79998885577', '07.04.2025', 'Оставить у подъезда']
    test_data_2 = ['Наполеон', 'Бонапарт', 'Елисейские Поля, 1', 'Сокольники', '+78887771122', '10.04.2025', 'До двери']
    ...
    dzen_title_page = ('Дзен — платформа для просмотра и создания контента. '
